...
module.exports = {
  ...
  output: {
    // Configuración de salida, o sea, donde se guardará el bundle
  ...
  module: {
    // Configuración de los módulos, los modulos son: loaders, rules, etc.
    rules: [
        ...
        use: [
          ...
          MiniCssExtractPlugin.loader, // Extrae el css a un archivo independiente
          {
            ...
            options: {
              // Opciones del loader
              modules: {
                // Habilita el uso de módulosy poder importar estilos en los archivos js asi: import estilos from './estilos.css';
      ...
      },
      {
        ...
        use: {
          ...
          options: {
            ...
            optipng: {
              // Optimiza las imágenes png
              enabled: false, // Habilita la optimización
            },
            pngquant: {
              // Optimiza las imágenes png, a diferencia de optipng, pngquant es más agresivo
              quality: [0.65, 0.9], // Calidad de la imagen
              speed: 4, // Velocidad de optimización
            },
            gifsicle: {
              // Optimiza las imágenes gif
              interlaced: false, // Habilita la optimización entrelazada, o sea, la imagen se va cargando a medida que se va descargando
            },
            webp: {
              // Optimiza las imágenes webp
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      // Genera un archivo html en el directorio de salida
      template: "./index.html", // Plantilla html
      filename: "index.html", // Nombre del archivo de salida
    }),
    new MiniCssExtractPlugin({
      // Extrae el css a un archivo independiente
